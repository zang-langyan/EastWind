...
#define MASK_MACHO_DYNAMIC_NO_PIC (1U << 10)
...
enum opt_code
{
  ...
  OPT_MT = 409,                              /* -MT */
  OPT_Mach = 410,                            /* -Mach */
  OPT_Mmodules = 411,                        /* -Mmodules */
  OPT_Mno_modules = 412,                     /* -Mno-modules */
  OPT_N = 413,                               /* -N */
  OPT_O = 414,                               /* -O */
  OPT_Ofast = 415,                           /* -Ofast */
  OPT_Og = 416,                              /* -Og */
  ...
  OPT_Tbss_ = 427,                           /* -Tbss= */
  OPT_Tdata = 428,                           /* -Tdata */
  OPT_Tdata_ = 429,                          /* -Tdata= */
  OPT_Ttext = 430,                           /* -Ttext */
  OPT_Ttext_ = 431,                          /* -Ttext= */
  OPT_U = 432,                               /* -U */
  /* OPT_W = 433, */                         /* -W */
  OPT_WNSObject_attribute = 434,             /* -WNSObject-attribute */
  OPT_Wa_ = 435,                             /* -Wa, */
  OPT_Wabi = 436,                            /* -Wabi */
  OPT_Wabi_tag = 437,                        /* -Wabi-tag */
  OPT_Wabi_ = 438,                           /* -Wabi= */
  OPT_Wabsolute_value = 439,                 /* -Wabsolute-value */
  OPT_Waddress = 440,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 441,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 442,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 443,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 444,                       /* -Waliasing */
  OPT_Walign_commons = 445,                  /* -Walign-commons */
  /* OPT_Waligned_new = 446, */              /* -Waligned-new */
  OPT_Waligned_new_ = 447,                   /* -Waligned-new= */
  OPT_Wall = 448,                            /* -Wall */
  OPT_Walloc_size_larger_than_ = 449,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 450,                     /* -Walloc-zero */
  OPT_Walloca = 451,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 452,            /* -Walloca-larger-than= */
  OPT_Wampersand = 453,                      /* -Wampersand */
  OPT_Wanalyzer_allocation_size = 454,       /* -Wanalyzer-allocation-size */
  OPT_Wanalyzer_deref_before_check = 455,    /* -Wanalyzer-deref-before-check */
  ...
  OPT_Wanalyzer_exposure_through_uninit_copy = 459,/* -Wanalyzer-exposure-through-uninit-copy */
  OPT_Wanalyzer_fd_access_mode_mismatch = 460,/* -Wanalyzer-fd-access-mode-mismatch */
  OPT_Wanalyzer_fd_double_close = 461,       /* -Wanalyzer-fd-double-close */
  OPT_Wanalyzer_fd_leak = 462,               /* -Wanalyzer-fd-leak */
  OPT_Wanalyzer_fd_phase_mismatch = 463,     /* -Wanalyzer-fd-phase-mismatch */
  OPT_Wanalyzer_fd_type_mismatch = 464,      /* -Wanalyzer-fd-type-mismatch */
  OPT_Wanalyzer_fd_use_after_close = 465,    /* -Wanalyzer-fd-use-after-close */
  OPT_Wanalyzer_fd_use_without_check = 466,  /* -Wanalyzer-fd-use-without-check */
  OPT_Wanalyzer_file_leak = 467,             /* -Wanalyzer-file-leak */
  OPT_Wanalyzer_free_of_non_heap = 468,      /* -Wanalyzer-free-of-non-heap */
  OPT_Wanalyzer_imprecise_fp_arithmetic = 469,/* -Wanalyzer-imprecise-fp-arithmetic */
  OPT_Wanalyzer_infinite_recursion = 470,    /* -Wanalyzer-infinite-recursion */
  OPT_Wanalyzer_jump_through_null = 471,     /* -Wanalyzer-jump-through-null */
  OPT_Wanalyzer_malloc_leak = 472,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_mismatching_deallocation = 473,/* -Wanalyzer-mismatching-deallocation */
  OPT_Wanalyzer_null_argument = 474,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 475,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_out_of_bounds = 476,         /* -Wanalyzer-out-of-bounds */
  OPT_Wanalyzer_possible_null_argument = 477,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 478,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_putenv_of_auto_var = 479,    /* -Wanalyzer-putenv-of-auto-var */
  OPT_Wanalyzer_shift_count_negative = 480,  /* -Wanalyzer-shift-count-negative */
  OPT_Wanalyzer_shift_count_overflow = 481,  /* -Wanalyzer-shift-count-overflow */
  OPT_Wanalyzer_stale_setjmp_buffer = 482,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_tainted_allocation_size = 483,/* -Wanalyzer-tainted-allocation-size */
  OPT_Wanalyzer_tainted_array_index = 484,   /* -Wanalyzer-tainted-array-index */
  OPT_Wanalyzer_tainted_assertion = 485,     /* -Wanalyzer-tainted-assertion */
  OPT_Wanalyzer_tainted_divisor = 486,       /* -Wanalyzer-tainted-divisor */
  OPT_Wanalyzer_tainted_offset = 487,        /* -Wanalyzer-tainted-offset */
  OPT_Wanalyzer_tainted_size = 488,          /* -Wanalyzer-tainted-size */
  OPT_Wanalyzer_too_complex = 489,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 490,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 491,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 492,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 493,/* -Wanalyzer-use-of-uninitialized-value */
  OPT_Wanalyzer_va_arg_type_mismatch = 494,  /* -Wanalyzer-va-arg-type-mismatch */
  OPT_Wanalyzer_va_list_exhausted = 495,     /* -Wanalyzer-va-list-exhausted */
  OPT_Wanalyzer_va_list_leak = 496,          /* -Wanalyzer-va-list-leak */
  OPT_Wanalyzer_va_list_use_after_va_end = 497,/* -Wanalyzer-va-list-use-after-va-end */
  OPT_Wanalyzer_write_to_const = 498,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 499,/* -Wanalyzer-write-to-string-literal */
  OPT_Wargument_mismatch = 500,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 501,               /* -Warith-conversion */
  /* OPT_Warray_bounds = 502, */             /* -Warray-bounds */
  OPT_Warray_bounds_ = 503,                  /* -Warray-bounds= */
  OPT_Warray_compare = 504,                  /* -Warray-compare */
  /* OPT_Warray_parameter = 505, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 506,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 507,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 508,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 509, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 510,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 511,              /* -Wattribute-warning */
  OPT_Wattributes = 512,                     /* -Wattributes */
  OPT_Wattributes_ = 513,                    /* -Wattributes= */
  OPT_Wbad_function_cast = 514,              /* -Wbad-function-cast */
  /* OPT_Wbidi_chars = 515, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 516,                    /* -Wbidi-chars= */
  OPT_Wbool_compare = 517,                   /* -Wbool-compare */
  OPT_Wbool_operation = 518,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 519,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 520,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 521,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 522, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 523,                   /* -Wc++11-compat */
  OPT_Wc__11_extensions = 524,               /* -Wc++11-extensions */
  OPT_Wc__14_compat = 525,                   /* -Wc++14-compat */
  OPT_Wc__14_extensions = 526,               /* -Wc++14-extensions */
  OPT_Wc__17_compat = 527,                   /* -Wc++17-compat */
  OPT_Wc__17_extensions = 528,               /* -Wc++17-extensions */
  /* OPT_Wc__1z_compat = 529, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 530,                   /* -Wc++20-compat */
  OPT_Wc__20_extensions = 531,               /* -Wc++20-extensions */
  OPT_Wc__23_extensions = 532,               /* -Wc++23-extensions */
  /* OPT_Wc__2a_compat = 533, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 534,                 /* -Wc-binding-type */
  OPT_Wc11_c2x_compat = 535,                 /* -Wc11-c2x-compat */
  OPT_Wc90_c99_compat = 536,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 537,                 /* -Wc99-c11-compat */
  OPT_Wcannot_profile = 538,                 /* -Wcannot-profile */
  ...
  OPT_Wnonportable_cfstrings = 708,          /* -Wnonportable-cfstrings */
  /* OPT_Wnormalized = 709, */               /* -Wnormalized */
  OPT_Wnormalized_ = 710,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 711,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 712,                /* -Wobjc-root-class */
  OPT_Wodr = 713,                            /* -Wodr */
  OPT_Wold_style_cast = 714,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 715,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 716,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 717,            /* -Wopenacc-parallelism */
  OPT_Wopenmp_simd = 718,                    /* -Wopenmp-simd */
  OPT_Woverflow = 719,                       /* -Woverflow */
  OPT_Woverlength_strings = 720,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 721, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 722,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 723,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 724,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 725,            /* -Woverwrite-recursive */
  OPT_Wp_ = 726,                             /* -Wp, */
  OPT_Wpacked = 727,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 728,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 729,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 730,                         /* -Wpadded */
  OPT_Wparentheses = 731,                    /* -Wparentheses */
  OPT_Wpedantic = 732,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 733,                  /* -Wpedantic-cast */
  OPT_Wpedantic_param_names = 734,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 735,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 736, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 737,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 738,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 739,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 740,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 741,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 742,            /* -Wpointer-to-int-cast */
  ...
  OPT_Wuninitialized = 838,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 839,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 840, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 841, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 842,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 843,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 844,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 845,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 846, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 847,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 848,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 849,                /* -Wunused-function */
  OPT_Wunused_label = 850,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 851,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 852,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 853,               /* -Wunused-parameter */
  OPT_Wunused_result = 854,                  /* -Wunused-result */
  OPT_Wunused_value = 855,                   /* -Wunused-value */
  OPT_Wunused_variable = 856,                /* -Wunused-variable */
  OPT_Wuse_after_free = 857,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 858,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 859,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 860,                   /* -Wuseless-cast */
  OPT_Wvarargs = 861,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 862,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 863,   /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 864,              /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 865,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 866,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 867,            /* -Wvirtual-move-assign */
  OPT_Wvla = 868,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 869,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 870,                  /* -Wvla-parameter */
  OPT_Wvolatile = 871,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 872,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 873,                  /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 874,                /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 875,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 876,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 877,                       /* -Wzerotrip */
  OPT_X = 878,                               /* -X */
  OPT_Xassembler = 879,                      /* -Xassembler */
  OPT_Xf = 880,                              /* -Xf */
  OPT_Xlinker = 881,                         /* -Xlinker */
  OPT_Xpreprocessor = 882,                   /* -Xpreprocessor */
  OPT_Z = 883,                               /* -Z */
  OPT_all_load = 884,                        /* -all_load */
  OPT_allowable_client = 885,                /* -allowable_client */
  OPT_ansi = 886,                            /* -ansi */
  OPT_arch = 887,                            /* -arch */
  OPT_arch_errors_fatal = 888,               /* -arch_errors_fatal */
  OPT_asm_macosx_version_min_ = 889,         /* -asm_macosx_version_min= */
  OPT_aux_info = 890,                        /* -aux-info */
  /* OPT_aux_info_ = 891, */                 /* -aux-info= */
  OPT_bind_at_load = 892,                    /* -bind_at_load */
  OPT_bundle = 893,                          /* -bundle */
  OPT_bundle_loader = 894,                   /* -bundle_loader */
  OPT_c = 895,                               /* -c */
  OPT_callgraph = 896,                       /* -callgraph */
  OPT_client_name = 897,                     /* -client_name */
  OPT_compatibility_version = 898,           /* -compatibility_version */
  OPT_coverage = 899,                        /* -coverage */
  OPT_cpp = 900,                             /* -cpp */
  OPT_cpp_ = 901,                            /* -cpp= */
  OPT_current_version = 902,                 /* -current_version */
  OPT_d = 903,                               /* -d */
  OPT_dead_strip = 904,                      /* -dead_strip */
  OPT_debuglib_ = 905,                       /* -debuglib= */
  OPT_defaultlib_ = 906,                     /* -defaultlib= */
  OPT_defined_only = 907,                    /* -defined-only */
  OPT_demangle = 908,                        /* -demangle */
  /* OPT_dependency_file = 909, */           /* -dependency-file */
  OPT_dstartfiles = 910,                     /* -dstartfiles */
  OPT_dump_body_ = 911,                      /* -dump-body= */
  OPT_dump_level_ = 912,                     /* -dump-level= */
  OPT_dumpbase = 913,                        /* -dumpbase */
  OPT_dumpbase_ext = 914,                    /* -dumpbase-ext */
  OPT_dumpdir = 915,                         /* -dumpdir */
  OPT_dumpfullversion = 916,                 /* -dumpfullversion */
  OPT_dumpmachine = 917,                     /* -dumpmachine */
  OPT_dumpspecs = 918,                       /* -dumpspecs */
  OPT_dumpversion = 919,                     /* -dumpversion */
  OPT_dylib_file = 920,                      /* -dylib_file */
  OPT_dylinker = 921,                        /* -dylinker */
  OPT_dylinker_install_name = 922,           /* -dylinker_install_name */
  OPT_dynamic = 923,                         /* -dynamic */
  OPT_dynamiclib = 924,                      /* -dynamiclib */
  OPT_e = 925,                               /* -e */
  OPT_export_dynamic = 926,                  /* -export-dynamic */
  OPT_exported_symbols_list = 927,           /* -exported_symbols_list */
  OPT_fPIC = 928,                            /* -fPIC */
  OPT_fPIE = 929,                            /* -fPIE */
  OPT_fRTS_ = 930,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 931,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 932,                   /* -fabi-version= */
  OPT_faccess_control = 933,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 934,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 935,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 936,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 937,                  /* -falign-commons */
  OPT_falign_functions = 938,                /* -falign-functions */
  OPT_falign_functions_ = 939,               /* -falign-functions= */
  OPT_falign_jumps = 940,                    /* -falign-jumps */
  OPT_falign_jumps_ = 941,                   /* -falign-jumps= */
  OPT_falign_labels = 942,                   /* -falign-labels */
  OPT_falign_labels_ = 943,                  /* -falign-labels= */
  OPT_falign_loops = 944,                    /* -falign-loops */
  OPT_falign_loops_ = 945,                   /* -falign-loops= */
  /* OPT_faligned_new = 946, */              /* -faligned-new */
  OPT_faligned_new_ = 947,                   /* -faligned-new= */
  OPT_fall_instantiations = 948,             /* -fall-instantiations */
  OPT_fall_intrinsics = 949,                 /* -fall-intrinsics */
  OPT_fall_virtual = 950,                    /* -fall-virtual */
  OPT_fallocation_dce = 951,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 952,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 953,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 954,       /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 955, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 956,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 957,         /* -falt-external-templates */
  OPT_fanalyzer = 958,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 959,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 960,              /* -fanalyzer-checker= */
  OPT_fanalyzer_feasibility = 961,           /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 962,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 963,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_state_merge = 964,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 965,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 966,    /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 967,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 968,         /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 969,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 970, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 971,            /* -fanalyzer-verbosity= */
  OPT_fapple_kext = 972,                     /* -fapple-kext */
  /* OPT_fargument_alias = 973, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 974, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 975, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 976, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 977,            /* -fasan-shadow-offset= */
  OPT_fasm = 978,                            /* -fasm */
  OPT_fassert = 979,                         /* -fassert */
  OPT_fassociative_math = 980,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 981,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 982,                   /* -fauto-inc-dec */
  OPT_fauto_init = 983,                      /* -fauto-init */
  OPT_fauto_profile = 984,                   /* -fauto-profile */
  OPT_fauto_profile_ = 985,                  /* -fauto-profile= */
  OPT_fautomatic = 986,                      /* -fautomatic */
  OPT_fbackslash = 987,                      /* -fbackslash */
  OPT_fbacktrace = 988,                      /* -fbacktrace */
  OPT_fbit_tests = 989,                      /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 990,             /* -fblas-matmul-limit= */
  OPT_fbounds = 991,                         /* -fbounds */
  OPT_fbounds_check = 992,                   /* -fbounds-check */
  OPT_fbounds_check_ = 993,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 994,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 995,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 996, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 997, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 998, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 999,                /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1000,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1001,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1002,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1003,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1004,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1005,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1006,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1007,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1008,                    /* -fcall-used- */
  OPT_fcaller_saves = 1009,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1010,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1011,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1012,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1013,      /* -fcanonical-system-headers */
  OPT_fcase = 1014,                          /* -fcase */
  /* OPT_fcf_protection = 1015, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1016,                /* -fcf-protection= */
  OPT_fchar8_t = 1017,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1018,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1019, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1020,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1021,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1022,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1023, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1024, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1025, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1026, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1027, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1028, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1029,                  /* -fcheckaction= */
  OPT_fchecking = 1030,                      /* -fchecking */
  OPT_fchecking_ = 1031,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1032,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1033,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1034,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1035,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1036,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1037,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1038,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1039,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1040,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1041,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1042,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1043,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1044,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1045,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1046,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1047,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1048,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1049,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1050, */                /* -fcilkplus */
  OPT_fcoarray_ = 1051,                      /* -fcoarray= */
  OPT_fcode_hoisting = 1052,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1053,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1054,                        /* -fcommon */
  OPT_fcompare_debug = 1055,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1056,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1057,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1058,                  /* -fcompare-elim */
  OPT_fconcepts = 1059,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1060,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1061,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1062,                 /* -fcond-mismatch */
  /* OPT_fconserve_space = 1063, */          /* -fconserve-space */
  OPT_fconserve_stack = 1064,                /* -fconserve-stack */
  /* OPT_fconstant_cfstrings = 1065, */      /* -fconstant-cfstrings */
  OPT_fconstant_string_class_ = 1066,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1067,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1068,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1069,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1070,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1071,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1072,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1073,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1074,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1075,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1076,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1077,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1078, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1079,                     /* -fcontracts */
  OPT_fconvert_ = 1080,                      /* -fconvert= */
  OPT_fcoroutines = 1081,                    /* -fcoroutines */
  OPT_fcpp = 1082,                           /* -fcpp */
  OPT_fcpp_begin = 1083,                     /* -fcpp-begin */
  OPT_fcpp_end = 1084,                       /* -fcpp-end */
  OPT_fcprop_registers = 1085,               /* -fcprop-registers */
  OPT_fcray_pointer = 1086,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1087,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1088,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1089, */         /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 1090,              /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 1091,              /* -fcx-limited-range */
  OPT_fd = 1092,                             /* -fd */
  OPT_fd_lines_as_code = 1093,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1094,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1095,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1096,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1097,                      /* -fdbg-cnt= */
  OPT_fdce = 1098,                           /* -fdce */
  OPT_fdebug = 1099,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1100,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1101,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1102,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1103,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1104,             /* -fdebug-prefix-map= */
  OPT_fdebug_trace_api = 1105,               /* -fdebug-trace-api */
  OPT_fdebug_trace_quad = 1106,              /* -fdebug-trace-quad */
  OPT_fdebug_types_section = 1107,           /* -fdebug-types-section */
  OPT_fdebug_ = 1108,                        /* -fdebug= */
  OPT_fdec = 1109,                           /* -fdec */
  OPT_fdec_blank_format_item = 1110,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1111,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1112,           /* -fdec-format-defaults */
  OPT_fdec_include = 1113,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1114,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1115,                      /* -fdec-math */
  OPT_fdec_static = 1116,                    /* -fdec-static */
  OPT_fdec_structure = 1117,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1118,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1119, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1120,                          /* -fdef= */
  OPT_fdefault_double_8 = 1121,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1122, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1123,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1124,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1125,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1126,                /* -fdefault-real-8 */
  OPT_fdefer_pop = 1127,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1128,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1129,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1130,    /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 1131,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1132,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1133,    /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 1134, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1135,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1136,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1137,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1138,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1139,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1140,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 1141,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1142,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1143,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1144,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_show_caret = 1145,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1146,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 1147,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1148, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1149,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1150,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1151,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1152,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1153,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 1154,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1155,               /* -fdirectives-only */
  OPT_fdisable_ = 1156,                      /* -fdisable- */
  OPT_fdoc = 1157,                           /* -fdoc */
  OPT_fdoc_dir_ = 1158,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1159,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1160,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1161,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1162,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1163,                      /* -fdruntime */
  OPT_fdse = 1164,                           /* -fdse */
  OPT_fdump_ = 1165,                         /* -fdump- */
  OPT_fdump_ada_spec = 1166,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1167,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1168,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1169,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1170,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1171,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1172,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1173,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1174,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1175,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_json = 1176,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1177,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1178,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1179,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1180,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1181,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1182,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1183, */               /* -fdump-core */
  OPT_fdump_d_original = 1184,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1185,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1186,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1187,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1188,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1189,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1190,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1191,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1192,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1193, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1194,                   /* -fdump-passes */
  OPT_fdump_scos = 1195,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1196,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1197,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1198,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1199,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1200,                /* -fearly-inlining */
  OPT_felide_constructors = 1201,            /* -felide-constructors */
  OPT_felide_type = 1202,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1203, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1204,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1205,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1206,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1207,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1208,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1209,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1210,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1211,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1212,                /* -fenum-int-equiv */
  OPT_fexceptions = 1213,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1214,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1215,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1216,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1217,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1218,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1219,               /* -fextended-opaque */
  OPT_fextern_std_ = 1220,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1221,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1222,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1223,            /* -fexternal-templates */
  OPT_ff2c = 1224,                           /* -ff2c */
  OPT_ffast_math = 1225,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1226,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1227,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1228,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1229,              /* -ffinite-math-only */
  OPT_ffixed_ = 1230,                        /* -ffixed- */
  OPT_ffixed_form = 1231,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1232,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1233,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1234,                   /* -ffloat-store */
  OPT_ffloatvalue = 1235,                    /* -ffloatvalue */
  OPT_ffold_simple_inlines = 1236,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1237,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1238, */              /* -fforce-addr */
  OPT_fforward_propagate = 1239,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1240,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1241,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1242,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1243,                     /* -ffpe-trap= */
  OPT_ffree_form = 1244,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1245,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1246,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1247,                  /* -ffreestanding */
  OPT_ffriend_injection = 1248,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1249,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1250,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1251,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1252,             /* -ffunction-sections */
  OPT_fgcse = 1253,                          /* -fgcse */
  OPT_fgcse_after_reload = 1254,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1255,                      /* -fgcse-las */
  OPT_fgcse_lm = 1256,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1257,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1258,              /* -fgen-module-list= */
  OPT_fgimple = 1259,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1260,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1261,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1262,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1263,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1264,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1265,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1266,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1267,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1268,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1269,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1270,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1271,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1272,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1273,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1274,                  /* -fgo-embedcfg= */
  OPT_fgo_optimize_ = 1275,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1276,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1277,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1278,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1279,                      /* -fgraphite */
  OPT_fgraphite_identity = 1280,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1281,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1282,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1283, */       /* -fhandle-exceptions */
  OPT_fharden_compares = 1284,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1285,   /* -fharden-conditional-branches */
  /* OPT_fhelp = 1286, */                    /* -fhelp */
  /* OPT_fhelp_ = 1287, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1288,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1289,                     /* -fhonor-std */
  OPT_fhosted = 1290,                        /* -fhosted */
  OPT_fhuge_objects = 1291,                  /* -fhuge-objects */
  OPT_fident = 1292,                         /* -fident */
  OPT_fif_conversion = 1293,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1294,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1295,        /* -fignore-unknown-pragmas */
  OPT_filelist = 1296,                       /* -filelist */
  OPT_fimplement_inlines = 1297,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1298,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1299,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1300,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1301,            /* -fimplicit-templates */
  OPT_findex = 1302,                         /* -findex */
  OPT_findirect_inlining = 1303,             /* -findirect-inlining */
  OPT_findirect_virtual_calls = 1304,        /* -findirect-virtual-calls */
  OPT_finhibit_size_directive = 1305,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1306,               /* -finit-character= */
  OPT_finit_derived = 1307,                  /* -finit-derived */
  OPT_finit_integer_ = 1308,                 /* -finit-integer= */
  OPT_finit_local_zero = 1309,               /* -finit-local-zero */
  OPT_finit_logical_ = 1310,                 /* -finit-logical= */
  OPT_finit_real_ = 1311,                    /* -finit-real= */
  OPT_finline = 1312,                        /* -finline */
  OPT_finline_arg_packing = 1313,            /* -finline-arg-packing */
  OPT_finline_atomics = 1314,                /* -finline-atomics */
  OPT_finline_functions = 1315,              /* -finline-functions */
  OPT_finline_functions_called_once = 1316,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1317, */           /* -finline-limit- */
  OPT_finline_limit_ = 1318,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1319,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1320,        /* -finline-small-functions */
  OPT_finput_charset_ = 1321,                /* -finput-charset= */
  OPT_finstrument_functions = 1322,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1323,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1324,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1325,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1326,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1327,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1328,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1329,                    /* -finvariants */
  OPT_fipa_bit_cp = 1330,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1331,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1332, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1333,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1334,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1335,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1336,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1337, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1338,                    /* -fipa-modref */
  OPT_fipa_profile = 1339,                   /* -fipa-profile */
  OPT_fipa_pta = 1340,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1341,                /* -fipa-pure-const */
  OPT_fipa_ra = 1342,                        /* -fipa-ra */
  OPT_fipa_reference = 1343,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1344,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1345,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1346,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1347,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1348, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1349,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1350,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1351,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1352,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1353,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1354,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1355,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1356,                  /* -fira-verbose= */
  OPT_fiso = 1357,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1358,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1359,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1360,              /* -fivar-visibility= */
  OPT_fivopts = 1361,                        /* -fivopts */
  OPT_fjump_tables = 1362,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1363,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1364,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1365,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1366,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1367,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1368,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1369,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1370,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1371,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1372,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1373,         /* -flang-info-module-cmi= */
  OPT_flarge_source_files = 1374,            /* -flarge-source-files */
  OPT_flat_namespace = 1375,                 /* -flat_namespace */
  OPT_flax_vector_conversions = 1376,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1377,            /* -fleading-underscore */
  OPT_flibs_ = 1378,                         /* -flibs= */
  OPT_flifetime_dse = 1379,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1380,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1381,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1382,                /* -flinker-output= */
  /* OPT_flive_patching = 1383, */           /* -flive-patching */
  OPT_flive_patching_ = 1384,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1385,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1386,                   /* -flocal-ivars */
  OPT_flocation_ = 1387,                     /* -flocation= */
  /* OPT_floop_block = 1388, */              /* -floop-block */
  /* OPT_floop_flatten = 1389, */            /* -floop-flatten */
  OPT_floop_interchange = 1390,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1391,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1392, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1393,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1394, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1395,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1396,                     /* -flra-remat */
  OPT_flto = 1397,                           /* -flto */
  OPT_flto_compression_level_ = 1398,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1399, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1400,                /* -flto-partition= */
  OPT_flto_report = 1401,                    /* -flto-report */
  OPT_flto_report_wpa = 1402,                /* -flto-report-wpa */
  OPT_flto_ = 1403,                          /* -flto= */
  OPT_fltrans = 1404,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1405,           /* -fltrans-output-list= */
  OPT_fm2_g = 1406,                          /* -fm2-g */
  OPT_fm2_lower_case = 1407,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1408,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1409,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1410,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1411,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1412,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1413,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1414,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1415,             /* -fmacro-prefix-map= */
  OPT_fmain = 1416,                          /* -fmain */
  OPT_fmath_errno = 1417,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1418,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1419,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1420,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1421,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1422,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1423,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1424,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1425,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1426,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1427,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1428,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1429,               /* -fmessage-length= */
  OPT_fmod_ = 1430,                          /* -fmod= */
  OPT_fmodule_file_ = 1431,                  /* -fmodule-file= */
  OPT_fmodule_header = 1432,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1433,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1434,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1435,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1436,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1437,                   /* -fmodule-only */
  OPT_fmodule_private = 1438,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1439,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1440,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1441,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1442,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1443,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1444,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1445,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1446,                 /* -fms-extensions */
  OPT_fmudflap = 1447,                       /* -fmudflap */
  OPT_fmudflapir = 1448,                     /* -fmudflapir */
  OPT_fmudflapth = 1449,                     /* -fmudflapth */
  OPT_fmultiflags = 1450,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1451,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1452,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1453,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1454,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1455,                  /* -fnext-runtime */
  OPT_fnil = 1456,                           /* -fnil */
  OPT_fnil_receivers = 1457,                 /* -fnil-receivers */
  OPT_fno_modules = 1458,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1459,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1460,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1461,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1462,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1463,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1464,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1465,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1466,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1467,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1468,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1469,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1470,                /* -fobjc-std=objc1 */
  OPT_foff_stack_trampolines = 1471,         /* -foff-stack-trampolines */
  OPT_foffload_abi_ = 1472,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1473,              /* -foffload-options= */
  OPT_foffload_ = 1474,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1475,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1476,                         /* -fonly= */
  OPT_fopenacc = 1477,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1478,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1479,                        /* -fopenmp */
  OPT_fopenmp_simd = 1480,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1481, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1482,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1483,                /* -foperator-names */
  OPT_fopt_info = 1484,                      /* -fopt-info */
  OPT_fopt_info_ = 1485,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1486, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1487,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1488,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1489, */          /* -foptional-diags */
  OPT_force_cpusubtype_ALL = 1490,           /* -force_cpusubtype_ALL */
  OPT_force_flat_namespace = 1491,           /* -force_flat_namespace */
  OPT_fpack_derived = 1492,                  /* -fpack-derived */
  OPT_fpack_struct = 1493,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1494,                  /* -fpack-struct= */
  OPT_fpad_source = 1495,                    /* -fpad-source */
  OPT_fpartial_inlining = 1496,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1497,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1498,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1499,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1500,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1501,                    /* -fpeel-loops */
  OPT_fpeephole = 1502,                      /* -fpeephole */
  OPT_fpeephole2 = 1503,                     /* -fpeephole2 */
  OPT_fpermissive = 1504,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1505,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1506,                           /* -fpic */
  OPT_fpie = 1507,                           /* -fpie */
  OPT_fpim = 1508,                           /* -fpim */
  OPT_fpim2 = 1509,                          /* -fpim2 */
  OPT_fpim3 = 1510,                          /* -fpim3 */
  OPT_fpim4 = 1511,                          /* -fpim4 */
  OPT_fplan9_extensions = 1512,              /* -fplan9-extensions */
  OPT_fplt = 1513,                           /* -fplt */
  OPT_fplugin_arg_ = 1514,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1515,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1516,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1517,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1518,                /* -fpostconditions */
  OPT_fpre_include_ = 1519,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1520,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1521,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1522,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1523,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1524,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1525,              /* -fpretty-templates */
  OPT_fpreview_all = 1526,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1527,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1528,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1529,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1530,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1531,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1532,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1533,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1534,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1535,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1536,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1537,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1538,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_systemvariables = 1539,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1540,           /* -fprintf-return-value */
  OPT_fprofile = 1541,                       /* -fprofile */
  OPT_fprofile_abs_path = 1542,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1543,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1544,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1545,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1546,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1547,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1548,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1549,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1550,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1551,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1552,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1553,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1554,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1555,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1556,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1557,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1558,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1559,               /* -fprofile-update= */
  OPT_fprofile_use = 1560,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1561,                  /* -fprofile-use= */
  OPT_fprofile_values = 1562,                /* -fprofile-values */
  OPT_fprotect_parens = 1563,                /* -fprotect-parens */
  OPT_fpthread = 1564,                       /* -fpthread */
  OPT_fq = 1565,                             /* -fq */
  OPT_framework = 1566,                      /* -framework */
  OPT_frandom_seed = 1567,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1568,                  /* -frandom-seed= */
  OPT_frange = 1569,                         /* -frange */
  OPT_frange_check = 1570,                   /* -frange-check */
  OPT_freal_4_real_10 = 1571,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1572,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1573,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1574,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1575,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1576,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1577,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1578,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1579,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1580,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1581,               /* -frecord-marker=8 */
  OPT_frecursive = 1582,                     /* -frecursive */
  OPT_free = 1583,                           /* -free */
  OPT_freg_struct_return = 1584,             /* -freg-struct-return */
  /* OPT_fregmove = 1585, */                 /* -fregmove */
  OPT_frelease = 1586,                       /* -frelease */
  OPT_frename_registers = 1587,              /* -frename-registers */
  OPT_freorder_blocks = 1588,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1589,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1590,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1591,             /* -freorder-functions */
  OPT_frepack_arrays = 1592,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1593,          /* -freplace-objc-classes */
  OPT_frepo = 1594,                          /* -frepo */
  OPT_freport_bug = 1595,                    /* -freport-bug */
  OPT_frequire_return_statement = 1596,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1597,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1598, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1599,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1600,                   /* -fresolution= */
  OPT_freturn = 1601,                        /* -freturn */
  OPT_frevert_all = 1602,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1603,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1604,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1605,             /* -frevert=intpromote */
  OPT_frounding_math = 1606,                 /* -frounding-math */
  OPT_frtti = 1607,                          /* -frtti */
  OPT_fruntime_modules_ = 1608,              /* -fruntime-modules= */
  OPT_frust_cfg_ = 1609,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1610,           /* -frust-compile-until= */
  OPT_frust_crate_ = 1611,                   /* -frust-crate= */
  OPT_frust_debug = 1612,                    /* -frust-debug */
  OPT_frust_dump_ = 1613,                    /* -frust-dump- */
  OPT_frust_edition_ = 1614,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1615,           /* -frust-embed-metadata */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1616,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1617,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1618,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1619,         /* -frust-metadata-output= */
  OPT_fsanitize_address_use_after_scope = 1620,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1621,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1622,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1623,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1624,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1625,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1626,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1627, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1628,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1629,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1630,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1631,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1632,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1633,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1634,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1635,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1636, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1637,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1638,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1639,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1640,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1641,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1642,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1643,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1644,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1645,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1646,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1647,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1648,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1649,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1650,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1651,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1652,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1653, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1654,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1655,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1656,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1657,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1658,               /* -fsection-anchors */
  /* OPT_fsee = 1659, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1660,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1661,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1662,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1663,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1664,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1665,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1666,        /* -fsemantic-interposition */
  OPT_fshared = 1667,                        /* -fshared */
  OPT_fshort_enums = 1668,                   /* -fshort-enums */
  OPT_fshort_wchar = 1669,                   /* -fshort-wchar */
  OPT_fshow_column = 1670,                   /* -fshow-column */
  OPT_fshrink_wrap = 1671,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1672,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1673,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1674,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1675,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1676,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1677,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1678,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1679,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1680,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1681,                /* -fsoft-check-all */
  OPT_fsources = 1682,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1683,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1684,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1685,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1686,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1687,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1688,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1689,                      /* -fsquangle */
  OPT_fssa_backprop = 1690,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1691,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1692,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1693,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1694, */             /* -fstack-check */
  OPT_fstack_check_ = 1695,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1696,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1697,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1698,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1699,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1700,               /* -fstack-protector */
  OPT_fstack_protector_all = 1701,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1702,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1703,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1704,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1705,                   /* -fstack-usage */
  OPT_fstack_use_cumulative_args = 1706,     /* -fstack-use-cumulative-args */
  OPT_fstats = 1707,                         /* -fstats */
  OPT_fstdarg_opt = 1708,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1709,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1710, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1711,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1712,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1713, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1714,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1715,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1716,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1717,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1718, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1719,            /* -fstrong-eval-order= */
  OPT_fswig = 1720,                          /* -fswig */
  OPT_fswitch_errors = 1721,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1722,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1723,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1724,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1725, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1726,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1727, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1728,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1729, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1730,               /* -ftemplate-depth= */
  OPT_fterminated_vtables = 1731,            /* -fterminated-vtables */
  OPT_ftest_coverage = 1732,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1733,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1734,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1735,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1736,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1737,                   /* -ftime-report */
  OPT_ftime_report_details = 1738,           /* -ftime-report-details */
  OPT_ftls_model_ = 1739,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1740,              /* -ftoplevel-reorder */
  OPT_ftracer = 1741,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1742,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1743,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1744,                   /* -ftrampolines */
  OPT_ftransition_all = 1745,                /* -ftransition=all */
  OPT_ftransition_field = 1746,              /* -ftransition=field */
  OPT_ftransition_in = 1747,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1748,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1749,          /* -ftransition=templates */
  OPT_ftransition_tls = 1750,                /* -ftransition=tls */
  OPT_ftrapping_math = 1751,                 /* -ftrapping-math */
  OPT_ftrapv = 1752,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1753,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1754,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1755,                      /* -ftree-ccp */
  OPT_ftree_ch = 1756,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1757, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1758,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1759,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1760, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1761,                   /* -ftree-cselim */
  OPT_ftree_dce = 1762,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1763,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1764,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1765,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1766,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1767, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1768,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1769,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1770, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1771,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1772,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1773, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1774,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1775,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1776,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1777,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1778,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1779,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1780,                      /* -ftree-pre */
  OPT_ftree_pta = 1781,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1782,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1783, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1784,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1785,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1786,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1787,                     /* -ftree-slsr */
  OPT_ftree_sra = 1788,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1789, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1790, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1791,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1792,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1793,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1794, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1795,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1796, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1797,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1798,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1799,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1800,         /* -funconstrained-commons */
  OPT_funderscoring = 1801,                  /* -funderscoring */
  OPT_funit_at_a_time = 1802,                /* -funit-at-a-time */
  OPT_funittest = 1803,                      /* -funittest */
  OPT_funreachable_traps = 1804,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1805,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1806,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1807,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1808, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1809,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1810,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1811,                 /* -funsigned-char */
  OPT_funswitch_loops = 1812,                /* -funswitch-loops */
  OPT_funwind_tables = 1813,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1814,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1815,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1816,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1817,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1818,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1819,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1820,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1821,                     /* -fuse-list= */
  OPT_fvar_tracking = 1822,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1823,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1824,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1825,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1826,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1827, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1828,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1829,                   /* -fverbose-asm */
  /* OPT_fversion = 1830, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1831,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1832,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1833,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1834,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1835,                   /* -fvisibility= */
  OPT_fvpt = 1836,                           /* -fvpt */
  OPT_fvtable_gc = 1837,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1838,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1839,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1840,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1841,                     /* -fvtv-debug */
  OPT_fweak = 1842,                          /* -fweak */
  OPT_fweak_templates = 1843,                /* -fweak-templates */
  OPT_fweb = 1844,                           /* -fweb */
  /* OPT_fwhole_file = 1845, */              /* -fwhole-file */
  OPT_fwhole_program = 1846,                 /* -fwhole-program */
  OPT_fwholediv = 1847,                      /* -fwholediv */
  OPT_fwholevalue = 1848,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1849,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1850,             /* -fworking-directory */
  OPT_fwpa = 1851,                           /* -fwpa */
  OPT_fwpa_ = 1852,                          /* -fwpa= */
  OPT_fwrapv = 1853,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1854,                 /* -fwrapv-pointer */
  OPT_fxref = 1855,                          /* -fxref */
  /* OPT_fzee = 1856, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1857,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1858,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1859,                     /* -fzero-link */
  OPT_g = 1860,                              /* -g */
  OPT_gant = 1861,                           /* -gant */
  OPT_gas_loc_support = 1862,                /* -gas-loc-support */
  OPT_gas_locview_support = 1863,            /* -gas-locview-support */
  OPT_gbtf = 1864,                           /* -gbtf */
  OPT_gcoff = 1865,                          /* -gcoff */
  OPT_gcoff1 = 1866,                         /* -gcoff1 */
  OPT_gcoff2 = 1867,                         /* -gcoff2 */
  OPT_gcoff3 = 1868,                         /* -gcoff3 */
  OPT_gcolumn_info = 1869,                   /* -gcolumn-info */
  OPT_gctf = 1870,                           /* -gctf */
  OPT_gdescribe_dies = 1871,                 /* -gdescribe-dies */
  OPT_gdwarf = 1872,                         /* -gdwarf */
  OPT_gdwarf_ = 1873,                        /* -gdwarf- */
  OPT_gdwarf32 = 1874,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1875,                       /* -gdwarf64 */
  OPT_gen_decls = 1876,                      /* -gen-decls */
  OPT_gfull = 1877,                          /* -gfull */
  OPT_ggdb = 1878,                           /* -ggdb */
  OPT_ggnu_pubnames = 1879,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1880,                   /* -gimple-stats */
  OPT_ginline_points = 1881,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1882, /* -ginternal-reset-location-views */
  OPT_gnat = 1883,                           /* -gnat */
  OPT_gnatO = 1884,                          /* -gnatO */
  OPT_gno_ = 1885,                           /* -gno- */
  OPT_gno_pubnames = 1886,                   /* -gno-pubnames */
  OPT_gpubnames = 1887,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1888,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1889,                   /* -gsplit-dwarf */
  OPT_gstabs = 1890,                         /* -gstabs */
  OPT_gstabs_ = 1891,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1892,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1893,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1894,                        /* -gtoggle */
  OPT_gused = 1895,                          /* -gused */
  OPT_gvariable_location_views = 1896,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1897,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1898,                           /* -gvms */
  OPT_gxcoff = 1899,                         /* -gxcoff */
  OPT_gxcoff_ = 1900,                        /* -gxcoff+ */
  OPT_gz = 1901,                             /* -gz */
  OPT_gz_ = 1902,                            /* -gz= */
  OPT_h = 1903,                              /* -h */
  OPT_headerpad_max_install_names = 1904,    /* -headerpad_max_install_names */
  OPT_help = 1905,                           /* -help */
  OPT_idirafter = 1906,                      /* -idirafter */
  OPT_iframework = 1907,                     /* -iframework */
  OPT_imacros = 1908,                        /* -imacros */
  OPT_image_base = 1909,                     /* -image_base */
  OPT_imultiarch = 1910,                     /* -imultiarch */
  OPT_imultilib = 1911,                      /* -imultilib */
  OPT_include = 1912,                        /* -include */
  OPT_init = 1913,                           /* -init */
  OPT_install_name = 1914,                   /* -install_name */
  OPT_iplugindir_ = 1915,                    /* -iplugindir= */
  OPT_iprefix = 1916,                        /* -iprefix */
  OPT_iquote = 1917,                         /* -iquote */
  OPT_isysroot = 1918,                       /* -isysroot */
  OPT_isystem = 1919,                        /* -isystem */
  OPT_iwithprefix = 1920,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1921,              /* -iwithprefixbefore */
  OPT_k8 = 1922,                             /* -k8 */
  OPT_keep_private_externs = 1923,           /* -keep_private_externs */
  OPT_l = 1924,                              /* -l */
  OPT_lang_asm = 1925,                       /* -lang-asm */
  OPT_list = 1926,                           /* -list */
  OPT_m128bit_long_double = 1927,            /* -m128bit-long-double */
  OPT_m16 = 1928,                            /* -m16 */
  OPT_m32 = 1929,                            /* -m32 */
  OPT_m3dnow = 1930,                         /* -m3dnow */
  OPT_m3dnowa = 1931,                        /* -m3dnowa */
  OPT_m64 = 1932,                            /* -m64 */
  OPT_m80387 = 1933,                         /* -m80387 */
  OPT_m8bit_idiv = 1934,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1935,             /* -m96bit-long-double */
  OPT_mabi_ = 1936,                          /* -mabi= */
  OPT_mabm = 1937,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1938,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1939,                 /* -maddress-mode= */
  OPT_madx = 1940,                           /* -madx */
  OPT_maes = 1941,                           /* -maes */
  OPT_malign_data_ = 1942,                   /* -malign-data= */
  OPT_malign_double = 1943,                  /* -malign-double */
  OPT_malign_functions_ = 1944,              /* -malign-functions= */
  OPT_malign_jumps_ = 1945,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1946,                  /* -malign-loops= */
  OPT_malign_stringops = 1947,               /* -malign-stringops */
  OPT_mamx_bf16 = 1948,                      /* -mamx-bf16 */
  OPT_mamx_complex = 1949,                   /* -mamx-complex */
  OPT_mamx_fp16 = 1950,                      /* -mamx-fp16 */
  OPT_mamx_int8 = 1951,                      /* -mamx-int8 */
  OPT_mamx_tile = 1952,                      /* -mamx-tile */
  OPT_march_ = 1953,                         /* -march= */
  OPT_masm_ = 1954,                          /* -masm= */
  OPT_matt_stubs = 1955,                     /* -matt-stubs */
  OPT_mavx = 1956,                           /* -mavx */
  OPT_mavx2 = 1957,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1958,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1959,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1960,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1961,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1962,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1963,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1964,                      /* -mavx512bw */
  OPT_mavx512cd = 1965,                      /* -mavx512cd */
  OPT_mavx512dq = 1966,                      /* -mavx512dq */
  OPT_mavx512er = 1967,                      /* -mavx512er */
  OPT_mavx512f = 1968,                       /* -mavx512f */
  OPT_mavx512fp16 = 1969,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 1970,                    /* -mavx512ifma */
  OPT_mavx512pf = 1971,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1972,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1973,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1974,                      /* -mavx512vl */
  OPT_mavx512vnni = 1975,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1976,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1977,               /* -mavx512vpopcntdq */
  OPT_mavxifma = 1978,                       /* -mavxifma */
  OPT_mavxneconvert = 1979,                  /* -mavxneconvert */
  OPT_mavxvnni = 1980,                       /* -mavxvnni */
  OPT_mavxvnniint8 = 1981,                   /* -mavxvnniint8 */
  OPT_mbmi = 1982,                           /* -mbmi */
  OPT_mbmi2 = 1983,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1984,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1985,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1986,                    /* -mcet-switch */
  OPT_mcld = 1987,                           /* -mcld */
  OPT_mcldemote = 1988,                      /* -mcldemote */
  OPT_mclflushopt = 1989,                    /* -mclflushopt */
  OPT_mclwb = 1990,                          /* -mclwb */
  OPT_mclzero = 1991,                        /* -mclzero */
  OPT_mcmodel_ = 1992,                       /* -mcmodel= */
  OPT_mcmpccxadd = 1993,                     /* -mcmpccxadd */
  OPT_mconstant_cfstrings = 1994,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1995, */                    /* -mcpu= */
  OPT_mcrc32 = 1996,                         /* -mcrc32 */
  OPT_mcx16 = 1997,                          /* -mcx16 */
  OPT_mdaz_ftz = 1998,                       /* -mdaz-ftz */
  OPT_mdirect_extern_access = 1999,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 2000,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 2001,            /* -mdump-tune-features */
  OPT_mdynamic_no_pic = 2002,                /* -mdynamic-no-pic */
  OPT_menqcmd = 2003,                        /* -menqcmd */
  OPT_mf16c = 2004,                          /* -mf16c */
  OPT_mfancy_math_387 = 2005,                /* -mfancy-math-387 */
  OPT_mfentry = 2006,                        /* -mfentry */
  OPT_mfentry_name_ = 2007,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 2008,               /* -mfentry-section= */
  OPT_mfix_and_continue = 2009,              /* -mfix-and-continue */
  OPT_mfma = 2010,                           /* -mfma */
  OPT_mfma4 = 2011,                          /* -mfma4 */
  OPT_mforce_drap = 2012,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 2013,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 2014,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 2015,                       /* -mfpmath= */
  OPT_mfsgsbase = 2016,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 2017,              /* -mfunction-return= */
  /* OPT_mfused_madd = 2018, */              /* -mfused-madd */
  OPT_mfxsr = 2019,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 2020,             /* -mgeneral-regs-only */
  OPT_mgfni = 2021,                          /* -mgfni */
  OPT_mhard_float = 2022,                    /* -mhard-float */
  OPT_mharden_sls_ = 2023,                   /* -mharden-sls= */
  OPT_mhle = 2024,                           /* -mhle */
  OPT_mhreset = 2025,                        /* -mhreset */
  OPT_miamcu = 2026,                         /* -miamcu */
  OPT_mieee_fp = 2027,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 2028,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 2029,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 2030,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 2031,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 2032,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 2033,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 2034,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 2035, */            /* -mintel-syntax */
  OPT_mkernel = 2036,                        /* -mkernel */
  OPT_mkl = 2037,                            /* -mkl */
  OPT_mlam_ = 2038,                          /* -mlam= */
  OPT_mlarge_data_threshold_ = 2039,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 2040,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 2041,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 2042,                /* -mlong-double-80 */
  OPT_mlwp = 2043,                           /* -mlwp */
  OPT_mlzcnt = 2044,                         /* -mlzcnt */
  OPT_mmacosx_version_min_ = 2045,           /* -mmacosx-version-min= */
  OPT_mmanual_endbr = 2046,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 2047,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 2048,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 2049,                  /* -mmitigate-rop */
  OPT_mmmx = 2050,                           /* -mmmx */
  OPT_mmovbe = 2051,                         /* -mmovbe */
  OPT_mmovdir64b = 2052,                     /* -mmovdir64b */
  OPT_mmovdiri = 2053,                       /* -mmovdiri */
  OPT_mmove_max_ = 2054,                     /* -mmove-max= */
  OPT_mmpx = 2055,                           /* -mmpx */
  OPT_mms_bitfields = 2056,                  /* -mms-bitfields */
  OPT_mmwait = 2057,                         /* -mmwait */
  OPT_mmwaitx = 2058,                        /* -mmwaitx */
  OPT_mneeded = 2059,                        /* -mneeded */
  OPT_mno_align_stringops = 2060,            /* -mno-align-stringops */
  OPT_mno_default = 2061,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 2062,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 2063,                  /* -mno-push-args */
  OPT_mno_red_zone = 2064,                   /* -mno-red-zone */
  OPT_mno_sse4 = 2065,                       /* -mno-sse4 */
  OPT_mnop_mcount = 2066,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 2067,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 2068,                 /* -mone-byte-bool */
  OPT_mpc32 = 2069,                          /* -mpc32 */
  OPT_mpc64 = 2070,                          /* -mpc64 */
  OPT_mpc80 = 2071,                          /* -mpc80 */
  OPT_mpclmul = 2072,                        /* -mpclmul */
  OPT_mpcommit = 2073,                       /* -mpcommit */
  OPT_mpconfig = 2074,                       /* -mpconfig */
  OPT_mpku = 2075,                           /* -mpku */
  OPT_mpopcnt = 2076,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2077, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2078,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2079,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2080,                     /* -mprefetchi */
  OPT_mprefetchwt1 = 2081,                   /* -mprefetchwt1 */
  OPT_mprfchw = 2082,                        /* -mprfchw */
  OPT_mptwrite = 2083,                       /* -mptwrite */
  OPT_mpush_args = 2084,                     /* -mpush-args */
  OPT_mraoint = 2085,                        /* -mraoint */
  OPT_mrdpid = 2086,                         /* -mrdpid */
  OPT_mrdrnd = 2087,                         /* -mrdrnd */
  OPT_mrdseed = 2088,                        /* -mrdseed */
  OPT_mrecip = 2089,                         /* -mrecip */
  OPT_mrecip_ = 2090,                        /* -mrecip= */
  OPT_mrecord_mcount = 2091,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2092,                 /* -mrecord-return */
  OPT_mred_zone = 2093,                      /* -mred-zone */
  OPT_mregparm_ = 2094,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2095,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2096,                           /* -mrtd */
  OPT_mrtm = 2097,                           /* -mrtm */
  OPT_msahf = 2098,                          /* -msahf */
  OPT_mserialize = 2099,                     /* -mserialize */
  OPT_msgx = 2100,                           /* -msgx */
  OPT_msha = 2101,                           /* -msha */
  OPT_mshstk = 2102,                         /* -mshstk */
  OPT_mskip_rax_setup = 2103,                /* -mskip-rax-setup */
  OPT_msoft_float = 2104,                    /* -msoft-float */
  OPT_msse = 2105,                           /* -msse */
  OPT_msse2 = 2106,                          /* -msse2 */
  OPT_msse2avx = 2107,                       /* -msse2avx */
  OPT_msse3 = 2108,                          /* -msse3 */
  OPT_msse4 = 2109,                          /* -msse4 */
  OPT_msse4_1 = 2110,                        /* -msse4.1 */
  OPT_msse4_2 = 2111,                        /* -msse4.2 */
  OPT_msse4a = 2112,                         /* -msse4a */
  /* OPT_msse5 = 2113, */                    /* -msse5 */
  OPT_msseregparm = 2114,                    /* -msseregparm */
  OPT_mssse3 = 2115,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2116,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 2117, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2118,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 2119, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2120,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2121,                  /* -mstackrealign */
  OPT_mstore_max_ = 2122,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2123,            /* -mstringop-strategy= */
  OPT_mstv = 2124,                           /* -mstv */
  OPT_msymbol_stubs = 2125,                  /* -msymbol-stubs */
  OPT_mtarget_linker = 2126,                 /* -mtarget-linker */
  /* OPT_mtarget_linker_ = 2127, */          /* -mtarget-linker= */
  OPT_mtbm = 2128,                           /* -mtbm */
  OPT_mtls_dialect_ = 2129,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2130,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2131,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2132,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2133,                         /* -mtune= */
  OPT_muintr = 2134,                         /* -muintr */
  OPT_multi_module = 2135,                   /* -multi_module */
  OPT_multiply_defined = 2136,               /* -multiply_defined */
  OPT_multiply_defined_unused = 2137,        /* -multiply_defined_unused */
  OPT_munroll_only_small_loops = 2138,       /* -munroll-only-small-loops */
  OPT_mvaes = 2139,                          /* -mvaes */
  OPT_mveclibabi_ = 2140,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2141,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2142,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2143,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2144,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2145,                      /* -mwbnoinvd */
  OPT_mwidekl = 2146,                        /* -mwidekl */
  OPT_mx32 = 2147,                           /* -mx32 */
  OPT_mxop = 2148,                           /* -mxop */
  OPT_mxsave = 2149,                         /* -mxsave */
  OPT_mxsavec = 2150,                        /* -mxsavec */
  OPT_mxsaveopt = 2151,                      /* -mxsaveopt */
  OPT_mxsaves = 2152,                        /* -mxsaves */
  OPT_n = 2153,                              /* -n */
  OPT_name_sort = 2154,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2155,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2156,              /* -no-integrated-cpp */
  OPT_no_pie = 2157,                         /* -no-pie */
  OPT_no_dead_strip_inits_and_terms = 2158,  /* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 2159,                          /* -nocpp */
  OPT_nodefaultexport = 2160,                /* -nodefaultexport */
  OPT_nodefaultlibs = 2161,                  /* -nodefaultlibs */
  OPT_nodefaultrpaths = 2162,                /* -nodefaultrpaths */
  OPT_nofixprebinding = 2163,                /* -nofixprebinding */
  OPT_nolibc = 2164,                         /* -nolibc */
  OPT_nomultidefs = 2165,                    /* -nomultidefs */
  OPT_nophoboslib = 2166,                    /* -nophoboslib */
  OPT_noprebind = 2167,                      /* -noprebind */
  OPT_noseglinkedit = 2168,                  /* -noseglinkedit */
  OPT_nostartfiles = 2169,                   /* -nostartfiles */
  OPT_nostdinc = 2170,                       /* -nostdinc */
  OPT_nostdinc__ = 2171,                     /* -nostdinc++ */
  OPT_nostdlib = 2172,                       /* -nostdlib */
  OPT_nostdlib__ = 2173,                     /* -nostdlib++ */
  OPT_o = 2174,                              /* -o */
  OPT_object = 2175,                         /* -object */
  OPT_objects = 2176,                        /* -objects */
  OPT_p = 2177,                              /* -p */
  OPT_pagezero_size = 2178,                  /* -pagezero_size */
  OPT_pass_exit_codes = 2179,                /* -pass-exit-codes */
  /* OPT_pedantic = 2180, */                 /* -pedantic */
  OPT_pedantic_errors = 2181,                /* -pedantic-errors */
  OPT_pg = 2182,                             /* -pg */
  OPT_pie = 2183,                            /* -pie */
  OPT_pipe = 2184,                           /* -pipe */
  OPT_prebind = 2185,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 2186,   /* -prebind_all_twolevel_modules */
  OPT_preload = 2187,                        /* -preload */
  OPT_print_file_name_ = 2188,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2189,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2190,          /* -print-multi-directory */
  OPT_print_multi_lib = 2191,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2192,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2193,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2194,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2195,               /* -print-prog-name= */
  OPT_print_search_dirs = 2196,              /* -print-search-dirs */
  OPT_print_sysroot = 2197,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2198,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2199,                    /* -print-value */
  OPT_private_bundle = 2200,                 /* -private_bundle */
  OPT_pthread = 2201,                        /* -pthread */
  OPT_quiet = 2202,                          /* -quiet */
  OPT_r = 2203,                              /* -r */
  OPT_rdynamic = 2204,                       /* -rdynamic */
  OPT_read_only_relocs = 2205,               /* -read_only_relocs */
  OPT_remap = 2206,                          /* -remap */
  OPT_reverse_sort = 2207,                   /* -reverse-sort */
  OPT_rpath = 2208,                          /* -rpath */
  OPT_s = 2209,                              /* -s */
  OPT_save_temps = 2210,                     /* -save-temps */
  OPT_save_temps_ = 2211,                    /* -save-temps= */
  OPT_sectalign = 2212,                      /* -sectalign */
  OPT_sectcreate = 2213,                     /* -sectcreate */
  OPT_sectobjectsymbols = 2214,              /* -sectobjectsymbols */
  OPT_sectorder = 2215,                      /* -sectorder */
  OPT_seg1addr = 2216,                       /* -seg1addr */
  OPT_seg_addr_table = 2217,                 /* -seg_addr_table */
  OPT_seg_addr_table_filename = 2218,        /* -seg_addr_table_filename */
  OPT_segaddr = 2219,                        /* -segaddr */
  OPT_segcreate = 2220,                      /* -segcreate */
  OPT_seglinkedit = 2221,                    /* -seglinkedit */
  OPT_segprot = 2222,                        /* -segprot */
  OPT_segs_read_only_addr = 2223,            /* -segs_read_only_addr */
  OPT_segs_read_write_addr = 2224,           /* -segs_read_write_addr */
  OPT_shared = 2225,                         /* -shared */
  OPT_shared_libgcc = 2226,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2227,               /* -shared-libphobos */
  OPT_single_module = 2228,                  /* -single_module */
  OPT_size_sort = 2229,                      /* -size-sort */
  /* OPT_specs = 2230, */                    /* -specs */
  OPT_specs_ = 2231,                         /* -specs= */
  OPT_static = 2232,                         /* -static */
  OPT_static_libasan = 2233,                 /* -static-libasan */
  OPT_static_libgcc = 2234,                  /* -static-libgcc */
  OPT_static_libgfortran = 2235,             /* -static-libgfortran */
  OPT_static_libgm2 = 2236,                  /* -static-libgm2 */
  OPT_static_libgo = 2237,                   /* -static-libgo */
  OPT_static_libhwasan = 2238,               /* -static-libhwasan */
  OPT_static_liblsan = 2239,                 /* -static-liblsan */
  OPT_static_libmpx = 2240,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2241,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2242,               /* -static-libphobos */
  OPT_static_libquadmath = 2243,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2244,               /* -static-libstdc++ */
  OPT_static_libtsan = 2245,                 /* -static-libtsan */
  OPT_static_libubsan = 2246,                /* -static-libubsan */
  OPT_static_pie = 2247,                     /* -static-pie */
  /* OPT_std_c__03 = 2248, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2249, */                /* -std=c++0x */
  OPT_std_c__11 = 2250,                      /* -std=c++11 */
  OPT_std_c__14 = 2251,                      /* -std=c++14 */
  OPT_std_c__17 = 2252,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2253, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2254, */                /* -std=c++1z */
  OPT_std_c__20 = 2255,                      /* -std=c++20 */
  OPT_std_c__23 = 2256,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2257, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2258, */                /* -std=c++2b */
  OPT_std_c__98 = 2259,                      /* -std=c++98 */
  OPT_std_c11 = 2260,                        /* -std=c11 */
  OPT_std_c17 = 2261,                        /* -std=c17 */
  /* OPT_std_c18 = 2262, */                  /* -std=c18 */
  /* OPT_std_c1x = 2263, */                  /* -std=c1x */
  OPT_std_c2x = 2264,                        /* -std=c2x */
  /* OPT_std_c89 = 2265, */                  /* -std=c89 */
  OPT_std_c90 = 2266,                        /* -std=c90 */
  OPT_std_c99 = 2267,                        /* -std=c99 */
  /* OPT_std_c9x = 2268, */                  /* -std=c9x */
  OPT_std_f2003 = 2269,                      /* -std=f2003 */
  OPT_std_f2008 = 2270,                      /* -std=f2008 */
  OPT_std_f2008ts = 2271,                    /* -std=f2008ts */
  OPT_std_f2018 = 2272,                      /* -std=f2018 */
  OPT_std_f95 = 2273,                        /* -std=f95 */
  OPT_std_gnu = 2274,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2275, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2276, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2277,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2278,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2279,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2280, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2281, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2282,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2283,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2284, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2285, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2286,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2287,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2288,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2289, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2290, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2291,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2292, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2293,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2294,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2295, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2296, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2297,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2298, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2299, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2300, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2301, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2302, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2303,                     /* -std=legacy */
  OPT_stdlib_ = 2304,                        /* -stdlib= */
  OPT_sub_library = 2305,                    /* -sub_library */
  OPT_sub_umbrella = 2306,                   /* -sub_umbrella */
  OPT_symbol_ = 2307,                        /* -symbol= */
  OPT_symbolic = 2308,                       /* -symbolic */
  OPT_t = 2309,                              /* -t */
  OPT_time = 2310,                           /* -time */
  OPT_time_ = 2311,                          /* -time= */
  OPT_traditional = 2312,                    /* -traditional */
  OPT_traditional_cpp = 2313,                /* -traditional-cpp */
  OPT_tree_stats = 2314,                     /* -tree-stats */
  OPT_trigraphs = 2315,                      /* -trigraphs */
  OPT_twolevel_namespace = 2316,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 2317,       /* -twolevel_namespace_hints */
  OPT_type_stats = 2318,                     /* -type-stats */
  OPT_u = 2319,                              /* -u */
  OPT_umbrella = 2320,                       /* -umbrella */
  OPT_undef = 2321,                          /* -undef */
  OPT_undefined = 2322,                      /* -undefined */
  OPT_unexported_symbols_list = 2323,        /* -unexported_symbols_list */
  OPT_v = 2324,                              /* -v */
  OPT_version = 2325,                        /* -version */
  OPT_w = 2326,                              /* -w */
  OPT_weak_reference_mismatches = 2327,      /* -weak_reference_mismatches */
  OPT_whatsloaded = 2328,                    /* -whatsloaded */
  OPT_whyload = 2329,                        /* -whyload */
  OPT_wrapper = 2330,                        /* -wrapper */
  OPT_x = 2331,                              /* -x */
  OPT_y = 2332,                              /* -y */
  OPT_z = 2333,                              /* -z */
  N_OPTS,
